...
| AE-20260718-14 | **カーフの grain = 既存「質感.jpg」を full-frame で再利用（grainPolicy=`approved-reuse`・grainSamplingMethod=`approved-existing-asset-v1`）**。改訂13策定時のユーザー指示「質感.jpgは色を捨て、革の局所的な凹凸だけを利用」に基づく（生成時に質感.jpgから比率マップを構築する現行設計を維持・input=output=質感.jpg・1011×676・SHA `d0b7b644bcce2691b42b776f054ad2dd3f6c23313dab72f6a1b83b1292943a2a`・full-frame ROI {x:0,y:0,w:1011,h:676}）。質感の見た目の証跡=比較シートv2のカーフ列（grain-sheet/index.html・AE-20260718-13 と同一シート） |
